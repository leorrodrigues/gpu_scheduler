...
headers <- c("method","time","dc_fragmentation","footprint_vcpu","footprint_ram","fragmentation_link","footprint_link","footprint_bandwidth","rejected_tasks","accepted_tasks","accepted_performance", "type", "queue")
...
for(size in sizes){
    ...
    #######################################
    acceptedPlot <- ggplot()+
        geom_line(data=dt, aes(x=time, y=accepted_performance,  color=queue, linetype=type)) +
        theme_classic()+
        theme(
            legend.position="top",
    ...
    #######################################
    footVcpuPlot <- ggplot(data=dt, aes(x=time, y=footprint_vcpu, color=queue, linetype=type))+
        geom_line() +
        theme_classic()+
        theme(
            legend.position="top",
