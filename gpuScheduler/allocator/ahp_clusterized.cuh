...
bool ahp_clusterized(Builder* builder,  Container* container, std::map<unsigned int, unsigned int> &allocated_task, consumed_resource_t* consumed){

	printf("Cluster Size %d\n",builder->getClusteringResultSize());
