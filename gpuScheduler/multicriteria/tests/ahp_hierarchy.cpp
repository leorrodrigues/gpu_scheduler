...
SCENARIO("Hierarchy can be created, insert criterias, focus and alternatives",
	...
	GIVEN("A new AHP instance") {
		...
		WHEN("The Hierarchy are constructed") {
			...
			c->setLeaf(false);
			ahp->hierarchy->addEdge(o, c, weight, 4);
			c2 = ahp->hierarchy->addCriteria("L1");
			c2->setLeaf(true);
			ahp->hierarchy->addSheets(c2);
			ahp->hierarchy->addEdge(c, c2, weight, 4);
			c2 = ahp->hierarchy->addCriteria("L2");
			c2->setLeaf(true);
			ahp->hierarchy->addSheets(c2);
			ahp->hierarchy->addEdge(c, c2, weight, 4);
			c2 = ahp->hierarchy->addCriteria("L3");
			c2->setLeaf(true);
			ahp->hierarchy->addSheets(c2);
			ahp->hierarchy->addEdge(c, c2, weight, 4);
			c2 = ahp->hierarchy->addCriteria("L4");
			c2->setLeaf(true);
			ahp->hierarchy->addSheets(c2);
			ahp->hierarchy->addEdge(c, c2, weight, 4);
