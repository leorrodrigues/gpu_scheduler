...
__device__ const _Compare& key_comp() const {
	return *this;
}
...
__device__ pointer operator->() const {
	return (pointer)__i_.operator->();
}

__device__ __map_iterator& operator++() {
	++__i_; return *this;
}
...
__device__ __map_const_iterator& operator++() {
	++__i_; return *this;
}
...
__device__ iterator find(const key_type& __k)             {
	return __tree_.find(__k);
}
__device__ const_iterator find(const key_type& __k) const {
	return __tree_.find(__k);
}
...
__device__ key_compare    key_comp()      const {
