...
// :    the default values in the constructors of the complex and quaternions make for
...
// :    This is the Cayley norm, not the Euclidian norm...
...
// :    There is little point, for the octonions, to introduce the equivalents
